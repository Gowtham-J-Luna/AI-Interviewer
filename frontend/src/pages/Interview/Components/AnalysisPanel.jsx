      ...
      <div className="text-white text-sm space-y-6">
        ...
        {analysis && !isAnalyzing && (
          <div className="overflow-hidden">
            <InterviewDashboard analysis={analysis} currentQuestion={currentQuestion} transcript={transcript || ""} />
            ...
            <div className="bg-black border-2 border-white/20 p-6 rounded-xl shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-black border border-white/20 p-4 rounded-lg text-center">
                  ...
                  <div className="text-white font-semibold text-sm">
                    {recordingMeta?.durationMs ? `Saved (${Math.round(recordingMeta.durationMs / 1000)}s)` : "Captured"}
                  </div>
                </div>
                ...
                <div className="bg-black border border-white/20 p-4 rounded-lg text-center">
                  ...
                  <div className="text-xs text-gray-400 mb-1">Report Status</div>
                  <div className={`font-semibold text-sm ${canAnalyze ? "text-white" : "text-gray-400"}`}>
                    {reportSaved ? "Saved" : canAnalyze ? "Ready to save" : "Need more content"}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black rounded-lg p-4">
                ...
                <p className="text-gray-300 text-sm">
                  {canAnalyze
                    ? "Your response is ready for AI analysis and save. Finish the session to keep the transcript, report snapshot, and recording path in history."
                    : "Keep speaking to build a more substantial response before saving the interview."}
                </p>
              </div>
            </div>
          </div>
        ...
        {recordedChunks.length === 0 && !analysis && !isAnalyzing && (
          <div className="text-center py-12">
            ...
            <p className="text-white/50 text-sm">
              Start the interview to capture your video, transcript, and coaching data here.
            </p>
          </div>
        )}
      </div>
