  ...
  return (
    <div className="bg-black border border-white/30 rounded-xl p-6 min-h-[480px] flex flex-col flex-1">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-2">
          {speechSupported && (
            <LanguageSelector value={language} onChange={changeLanguage} disabled={isListening} />
          )}
      ...
      <div
        className="flex-1 text-white text-sm leading-relaxed overflow-y-auto max-h-96 pr-2 scroll-smooth"
        ...
        {isEditing ? (
          ...
          <div className="text-white/50 text-center py-8">
            {!speechSupported ? (
              ...
              <div>
                <p>Turn on the microphone or start the interview to enable the live transcript.</p>
                <p className="text-xs mt-2">Your spoken answer will appear here in real time.</p>
              </div>
            ) : (
              <div>
                ...
                {accuracy === 0 && (
                  <p className="text-xs mt-1 text-yellow-400">
                    Tip: speak clearly and at a moderate pace for better accuracy.
                  </p>
                )}
              </div>
            )}
