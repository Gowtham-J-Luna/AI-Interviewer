      ...
      >
        ...
        <div className={`flex items-center cursor-pointer transition-all duration-200 ${((isButtonsVisible && window.innerWidth >= 640) || isOpen) ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
          ...
          <div className="hidden sm:block">
            <div className="text-[15px] font-bold leading-3" style={{ color: "var(--app-navbar-text)" }}>
              {user.name || ""}
            </div>
            <div className="text-sm truncate max-w-[200px] mt-1" style={{ color: "var(--app-text-muted)" }}>
              {user.email || ""}
            </div>
          </div>
        </div>
        ...
        {isButtonsVisible && window.innerWidth >= 640 && (
          <div className="absolute inset-0 flex gap-2 items-center justify-end transition-all duration-200">
            ...
            <button
              className="p-2 bg-blue-600 cursor-pointer rounded-full shadow hover:bg-blue-700 text-white transition-all flex items-center justify-center"
